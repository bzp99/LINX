...
def initialize_agent_and_env(is_test=False):
    ...
    # hack to change the default value of the max_steps argument in the __init__ of LINXEnvCont to cfg.MAX_NUM_OF_STEPS
    atena_init_default_args = list(LINXEnvCont.__init__.__defaults__)
    atena_init_default_args[0] = cfg.MAX_NUM_OF_STEPS
    LINXEnvCont.__init__.__defaults__ = tuple(atena_init_default_args)
    ...
    LINXEnvCont.LOG_INTERVAL = int(args.log_interval / args.num_envs)
