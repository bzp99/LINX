...
from gym_linx.global_env_prop import update_global_env_prop_from_cfg
from gym_linx.lib.networking_helpers import convert_to_action_vector
...
def run_episode(agent=None,
    ...
    assert isinstance(env, LINXEnvCont)
...
class RecommenderAgent(object):
    ...
    def _create_agent(self, model_dir_path):
        command = f"train.py --env LINXcont-v0 --demo --load {model_dir_path}"
